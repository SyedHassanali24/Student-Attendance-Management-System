...
(() => {
    ...
    function getCurrentPayment(studentId) {
    ...
    function getLastPayment(studentId) {
    ...
    function showSlip(student) {
        ...
        overlay
            .querySelector("[data-slip-whatsapp]")
            ?.addEventListener(
                "click",
                () => {
    ...
    function printSlip(student, record) {
