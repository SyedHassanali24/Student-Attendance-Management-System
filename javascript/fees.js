...
(() => {
    ...
    const start = () => {
        ...
        function render() {
            ...
            const paidStudents = paidRecords.length;
        ...
        function openPayment(student) {
            ...
            const closeButton =
                overlay.querySelector(".fee-modal-close");

            const cancelButton =
                overlay.querySelector(".fee-cancel");
            ...
            const form =
                overlay.querySelector(".fee-payment-form");
